...
export const ConfigPropertyManager: ConfigPropertyManagerConstructor = class ConfigPropertyManager
    implements ConfigPropertyManagerInterface {
    ...
    setProperties(propertyOptions: ConfigPropertyDefinitionsMap, resetProperties = false) {
